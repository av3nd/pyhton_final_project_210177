...
# data frame
data_frame = LabelFrame(root, text="Record",font=('Consolas',11),bg='#b0ebea')
data_frame.pack(fill="x",expand="yes",padx=20)

# inside data frame
fn_label = Label(data_frame, text="First Name",font=('Consolas',11),bg='#b0ebea')
fn_label.grid(row=0,column=0,padx=10,pady=10)
fn_entry = Entry(data_frame)
fn_entry.grid(row=0,column=1, padx=10, pady=10)

ln_label = Label(data_frame, text="Last Name",font=('Consolas',11),bg='#b0ebea')
ln_label.grid(row=0,column=2,padx=10,pady=10)
ln_entry = Entry(data_frame)
ln_entry.grid(row=0,column=3, padx=10, pady=10)

id_label = Label(data_frame, text="ID",font=('Consolas',11),bg='#b0ebea')
id_label.grid(row=0,column=4,padx=10,pady=10)
id_entry = Entry(data_frame)
id_entry.grid(row=0,column=5, padx=10, pady=10)

address_label = Label(data_frame, text="Address",font=('Consolas',11),bg='#b0ebea')
address_label.grid(row=1,column=0,padx=10,pady=10)
address_entry = Entry(data_frame)
address_entry.grid(row=1,column=1, padx=10, pady=10)

city_label = Label(data_frame, text="City",font=('Consolas',11),bg='#b0ebea')
city_label.grid(row=1,column=2,padx=10,pady=10)
city_entry = Entry(data_frame)
city_entry.grid(row=1,column=3, padx=10, pady=10)

state_label = Label(data_frame, text="State",font=('Consolas',11),bg='#b0ebea')
...
zipcode_label = Label(data_frame, text="Zipcode",font=('Consolas',11),bg='#b0ebea')
...
# Button frame
button_frame = LabelFrame(root, text="Commands",font=('Consolas',11),bg='#b0ebea')
button_frame.pack(fill='x',expand="yes",padx=20)

update_button = Button(button_frame,text="Update",font=('Consolas',10),command=update_record,cursor='hand2',bg='lightgrey')
update_button.grid(row=0,column=0,padx=10,pady=10)

add_button = Button(button_frame,text="Add",font=('Consolas',10),command=add_record,cursor='hand2',bg='lightgrey')
add_button.grid(row=0,column=1,padx=10,pady=10)

delete_button = Button(button_frame,text="Delete",font=('Consolas',10),command=remove,cursor='hand2',bg='lightgrey')
delete_button.grid(row=0,column=2,padx=10,pady=10)

move_up_button = Button(button_frame,text="Move Up",command=up,font=('Consolas',10),cursor='hand2',bg='lightgrey')
move_up_button.grid(row=0,column=3,padx=10,pady=10)

move_down_button = Button(button_frame,text="Move Down",command=down,font=('Consolas',10),cursor='hand2',bg='lightgrey')
move_down_button.grid(row=0,column=4,padx=10,pady=10)

clear_record_button = Button(button_frame,text="Clear Entry Boxes",command=clear_entries,font=('Consolas',10),cursor='hand2',bg='lightgrey')
clear_record_button.grid(row=0,column=5,padx=10,pady=10)

search_record_button = Button(button_frame,text="Search Record",font=('Consolas',10),command=searching,cursor='hand2',bg='lightgrey')
search_record_button.grid(row=0,column=6,padx=10,pady=10)

refresh_button = Button(button_frame,text="Refresh Treview",font=('Consolas',10),command=refresh,cursor='hand2',bg='lightgrey')
